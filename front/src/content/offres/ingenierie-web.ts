...
const donnees = {
  ...
  accroche:
    'Concevoir, développer et exploiter un produit web ou mobile de bout en bout : architecture, front, back, données, qualité, mise en production et run.',
  decisionPermise:
  ...
  axes: [
    ...
    {
      cle: 'chefferie-amoa',
      titre: 'Chefferie de projet et AMOA',
      description:
        'Recueil du besoin, spécifications, BPMN 2.0, cartographie SI, matrice de risques, recette et tests d’acceptation. Je traduis un besoin métier en spécifications exploitables par des intervenants non spécialistes du domaine.',
      preuve:
